...
INSERT INTO categorias (id, name) VALUES (1, 'shoes');
INSERT INTO categorias (id, name) VALUES (2, 'books');
INSERT INTO categorias (id, name) VALUES (3, 'electronics');

delete from Productos;
INSERT INTO Productos (id, name, description, stock,price,status, created_at,categoria_id)
